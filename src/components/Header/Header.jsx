  ...
  return (
    <header>
      <div className="md:hidden">
        <div className="bg-slate-200 text-center font-thin text-xs">
          Livraison offerte à partir de 100 euros d'achat
        </div>
        <div className="flex items-center justify-between px-4 py-2">
          {/* Logo et icônes pour mobile */}
          <div className="flex items-center">
            <img src={logo} alt="logo" className="h-10 mr-4" />
          </div>
          {/* Bouton pour le menu déroulant en mobile */}
          <div className=" flex items-center justify-end">
            <IoPersonCircleOutline className="h-6 w-6 text-black mr-4 lg:hidden" />
            <FaShoppingCart className="h-6 w-6 text-black lg:hidden" />
            <button className="text-xl px-4 py-2 bg-white text-black">
              <FaBars />
            </button>
          </div>
        </div>
        {/* Barre de recherche et bouton "Saisie par ref." pour mobile */}
        <div className="flex justify-between items-center px-4 py-2 bg-slate-200">
          ...
          <button className="ml-2 px-4 py-2 border border-black bg-white text-sm">
            Saisie par ref.
          </button>
        </div>
      </div>
